...
A file named freetypePen.py.


## Class: FreeTypePen

**Description:** Pen to rasterize paths with FreeType. Requires `freetype-py` module.
...
### Function: outline(self, transform, evenOdd)

**Description:** Converts the current contours to ``FT_Outline``.
...
### Function: buffer(self, width, height, transform, contain, evenOdd)

**Description:** Renders the current contours within a bitmap buffer.
...
### Function: array(self, width, height, transform, contain, evenOdd)

**Description:** Returns the rendered contours as a numpy array. Requires `numpy`.
...
### Function: show(self, width, height, transform, contain, evenOdd)

**Description:** Plots the rendered contours with `pyplot`. Requires `numpy` and
`matplotlib`.
...
### Function: image(self, width, height, transform, contain, evenOdd)

**Description:** Returns the rendered contours as a PIL image. Requires `Pillow`.
...
**Description:** Computes the exact bounding box of an outline.
...
**Description:** Returns an outline's ‘control box’.
