...
### Function: refine_triangulation(self, return_tri_index, subdiv)

**Description:** Compute a uniformly refined triangulation *refi_triangulation* of
...
### Function: refine_field(self, z, triinterpolator, subdiv)
...
### Function: _refine_triangulation_once(triangulation, ancestors)

**Description:** Refine a `.Triangulation` by splitting each triangle into 4
