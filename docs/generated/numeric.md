...
A file named numeric.py.


### Function: _zeros_like_dispatcher(a, dtype, order, subok, shape)

### Function: zeros_like(a, dtype, order, subok, shape)
...
### Function: ones(shape, dtype, order)
...
### Function: _ones_like_dispatcher(a, dtype, order, subok, shape)

### Function: ones_like(a, dtype, order, subok, shape)
...
### Function: _full_dispatcher(shape, fill_value, dtype, order)

### Function: full(shape, fill_value, dtype, order)
...
### Function: _full_like_dispatcher(a, fill_value, dtype, order, subok, shape)

### Function: full_like(a, fill_value, dtype, order, subok, shape)
...
### Function: _count_nonzero_dispatcher(a, axis)

### Function: count_nonzero(a, axis)
...
### Function: _argwhere_dispatcher(a)
...
### Function: _flatnonzero_dispatcher(a)
...
### Function: _correlate_dispatcher(a, v, mode)

### Function: correlate(a, v, mode)
...
### Function: _convolve_dispatcher(a, v, mode)

### Function: convolve(a, v, mode)
...
### Function: _outer_dispatcher(a, b, out)

### Function: outer(a, b, out)
...
### Function: _tensordot_dispatcher(a, b, axes)

### Function: tensordot(a, b, axes)
...
### Function: _roll_dispatcher(a, shift, axis)

### Function: roll(a, shift, axis)
...
### Function: _rollaxis_dispatcher(a, axis, start)

### Function: rollaxis(a, axis, start)
...
### Function: normalize_axis_tuple(axis, ndim, argname, allow_duplicate)
...
### Function: _moveaxis_dispatcher(a, source, destination)
...
### Function: _cross_dispatcher(a, b, axisa, axisb, axisc, axis)

### Function: cross(a, b, axisa, axisb, axisc, axis)
...
### Function: indices(dimensions, dtype, sparse)
...
### Function: fromfunction(function, shape)
...
### Function: _frombuffer(buf, dtype, shape, order)
...
### Function: binary_repr(num, width)
...
### Function: base_repr(number, base, padding)
...
### Function: _allclose_dispatcher(a, b, rtol, atol, equal_nan)
...
### Function: _isclose_dispatcher(a, b, rtol, atol, equal_nan)
...
### Function: _array_equal_dispatcher(a1, a2, equal_nan)

### Function: _dtype_cannot_hold_nan(dtype)

### Function: array_equal(a1, a2, equal_nan)
...
### Function: _array_equiv_dispatcher(a1, a2)
...
### Function: extend_all(module)

### Function: err_if_insufficient(width, binwidth)
