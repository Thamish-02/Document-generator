...
A file named format.py.


### Function: _check_version(version)

### Function: magic(major, minor)
...
### Function: header_data_from_array_1_0(array)
...
**Description:** Takes a stringified header, and attaches the prefix and padding to it

### Function: _wrap_header_guess_version(header)

**Description:** Like `_wrap_header`, but chooses an appropriate version given the contents

### Function: _write_array_header(fp, d, version)

**Description:** Write the header for an array and returns the version used
...
### Function: write_array_header_1_0(fp, d)
...
### Function: write_array_header_2_0(fp, d)
...
### Function: read_array_header_1_0(fp, max_header_size)
...
### Function: read_array_header_2_0(fp, max_header_size)
...
### Function: _filter_header(s)

**Description:** Clean up 'L' in npz header ints.
...
### Function: _read_array_header(fp, version, max_header_size)

**Description:** see read_array_header_1_0

### Function: write_array(fp, array, version, allow_pickle, pickle_kwargs)
...
### Function: read_array(fp, allow_pickle, pickle_kwargs)
...
### Function: open_memmap(filename, mode, dtype, shape, fortran_order, version)
...
### Function: _read_bytes(fp, size, error_template)

**Description:** Read from file-like object until size bytes are read.
