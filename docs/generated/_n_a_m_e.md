...
### Function: makeName(string, nameID, platformID, platEncID, langID)

### Function: _makeWindowsName(name, nameID, language)

**Description:** Create a NameRecord for the Microsoft Windows platform
...
### Function: _makeMacName(name, nameID, language, font)

**Description:** Create a NameRecord for Apple platforms
...
### Function: visit(visitor, obj, attr, value)
...
### Function: getName(self, nameID, platformID, platEncID, langID)

### Function: getDebugName(self, nameID)

### Function: getFirstDebugName(self, nameIDs)

### Function: getBestFamilyName(self)

### Function: getBestSubFamilyName(self)

### Function: getBestFullName(self)

### Function: setName(self, string, nameID, platformID, platEncID, langID)

**Description:** Set the 'string' for the name record identified by 'nameID', 'platformID',
...
### Function: removeNames(self, nameID, platformID, platEncID, langID)

**Description:** Remove any name records identified by the given combination of 'nameID',
'platformID', 'platEncID' and 'langID'.

### Function: removeUnusedNames(ttFont)

**Description:** Remove any name records which are not in NameID range 0-255 and not utilized
within the font itself.

### Function: _findUnusedNameID(self, minNameID)

**Description:** Finds an unused name id.

The nameID is assigned in the range between 'minNameID' and 32767 (inclusive),
following the last nameID in the name table.

### Function: findMultilingualName(self, names, windows, mac, minNameID, ttFont)

**Description:** Return the name ID of an existing multilingual name that
...
### Function: addMultilingualName(self, names, ttFont, nameID, windows, mac, minNameID)

**Description:** Add a multilingual name, returning its name ID
...
### Function: addName(self, string, platforms, minNameID)

**Description:** Add a new name record containing 'string' for each (platformID, platEncID,
...
**Description:** Returns the Python encoding name for this name entry based on its platformID,
...
### Function: encodingIsUnicodeCompatible(self)

### Function: __str__(self)

### Function: isUnicode(self)

### Function: toUnicode(self, errors)

**Description:** If self.string is a Unicode string, return it; otherwise try decoding the
...
### Function: toBytes(self, errors)

**Description:** If self.string is a bytes object, return it; otherwise try encoding
