...
A file named pydevconsole_code.py.


### Function: _maybe_compile(compiler, source, filename, symbol)

### Function: _compile(source, filename, symbol)
...
### Function: interact(banner, readfunc, local, exitmsg)
...
### Function: __call__(self, source, filename, symbol)
...
### Function: __init__(self, compiled, updated_globals, updated_locals)
...
### Function: runsource(self, source, filename, symbol)
...
### Function: __init__(self, locals, filename)
...
### Function: resetbuffer(self)

**Description:** Reset the input buffer.

### Function: interact(self, banner, exitmsg)
...
**Description:** Push a line to the interpreter.
...
**Description:** Write a prompt and read a line.
