...
### Function: joinseq(seq)

### Function: strseq(object, convert, join)

**Description:** Recursively walk a sequence, stringifying each element.
...
### Function: convert(name, locals, formatarg, formatvalue)
