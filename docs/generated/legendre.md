...
A file named legendre.py.


### Function: poly2leg(pol)
...
### Function: legpow(c, pow, maxpower)
...
### Function: legint(c, m, k, lbnd, scl, axis)
...
### Function: legvander3d(x, y, z, deg)
...
### Function: legfit(x, y, deg, rcond, full, w)
