...
A file named laguerre.py.


### Function: poly2lag(pol)
...
### Function: lagpow(c, pow, maxpower)
...
### Function: lagint(c, m, k, lbnd, scl, axis)
...
### Function: lagvander3d(x, y, z, deg)
...
### Function: lagfit(x, y, deg, rcond, full, w)
