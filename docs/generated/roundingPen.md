...
A file named roundingPen.py.


## Class: RoundingPen

**Description:** Filter pen that rounds point coordinates and component XY offsets to integer. For
...
## Class: RoundingPointPen

**Description:** Filter point pen that rounds point coordinates and component XY offsets to integer.
...
### Function: __init__(self, outPen, roundFunc, transformRoundFunc)
