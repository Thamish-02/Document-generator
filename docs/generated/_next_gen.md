...
A file named _next_gen.py.


### Function: define(maybe_cls)

**Description:** A class decorator that adds :term:`dunder methods` according to
...
**Description:** Create a new :term:`field` / :term:`attribute` on a class.
...
### Function: asdict(inst)

**Description:** Same as `attr.asdict`, except that collections types are always retained
and dict is always used as *dict_factory*.

.. versionadded:: 21.3.0

### Function: astuple(inst)

**Description:** Same as `attr.astuple`, except that collections types are always retained
...
**Description:** Inspect the class and return its effective build parameters.
...
### Function: do_it(cls, auto_attribs)

### Function: wrap(cls)

**Description:** Making this a wrapper ensures this code runs during class creation.
