...
### Function: __init__(self, ax, scale, unit, format, gap, radius, shoulder, offset, head_angle, margin, tolerance)

**Description:** Create a new Sankey instance.
...
### Function: _arc(self, quadrant, cw, radius, center)

**Description:** Return the codes and vertices for a rotated, scaled, and translated
90 degree arc.
...
### Function: _add_input(self, path, angle, flow, length)

**Description:** Add an input to a path and return its tip and label locations.

### Function: _add_output(self, path, angle, flow, length)

**Description:** Append an output to a path and return its tip and label locations.

.. note:: *flow* is negative for an output.

### Function: _revert(self, path, first_action)

**Description:** A path is not simply reversible by path[::-1] since the code
specifies an action to take from the **previous** point.

### Function: add(self, patchlabel, flows, orientations, labels, trunklength, pathlengths, prior, connect, rotation)

**Description:** Add a simple Sankey diagram with flows at the same hierarchical level.
...
**Description:** Adjust the Axes and return a list of information about the Sankey
subdiagram(s).
