...
A file named chebyshev.py.


### Function: _cseries_to_zseries(c)

**Description:** Convert Chebyshev series to z-series.
...
### Function: _zseries_to_cseries(zs)

**Description:** Convert z-series to a Chebyshev series.
...
### Function: _zseries_mul(z1, z2)

**Description:** Multiply two z-series.
...
### Function: _zseries_div(z1, z2)

**Description:** Divide the first z-series by the second.
...
### Function: _zseries_der(zs)

**Description:** Differentiate a z-series.
...
### Function: _zseries_int(zs)

**Description:** Integrate a z-series.
...
### Function: chebpow(c, pow, maxpower)
...
### Function: chebint(c, m, k, lbnd, scl, axis)
...
### Function: chebvander3d(x, y, z, deg)
...
### Function: chebfit(x, y, deg, rcond, full, w)
...
### Function: chebinterpolate(func, deg, args)
...
### Function: interpolate(cls, func, deg, domain, args)
