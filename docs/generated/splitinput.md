...
A file named splitinput.py.


### Function: split_user_input(line, pattern)

**Description:** Split user input into initial whitespace, escape character, function part
and the rest.

## Class: LineInfo

**Description:** A single line of input and associated info.
...
### Function: __init__(self, line, continue_prompt)

### Function: ofind(self, ip)

**Description:** Do a full, attribute-walking lookup of the ifun in the various
