...
A file named kerning.py.


### Function: lookupKerningValue(pair, kerning, groups, fallback, glyphToFirstGroup, glyphToSecondGroup)

**Description:** Retrieve the kerning value (if any) between a pair of elements.
