...
A file named _triangulation.py.
...
### Function: __init__(self, x, y, triangles, mask)

### Function: calculate_plane_coefficients(self, z)
...
### Function: _extract_triangulation_params(args, kwargs)

### Function: get_trifinder(self)

**Description:** Return the default `matplotlib.tri.TriFinder` of this
triangulation, creating it if necessary.  This allows the same
TriFinder object to be easily shared.

### Function: neighbors(self)
