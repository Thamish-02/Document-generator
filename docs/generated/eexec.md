...
A file named eexec.py.


### Function: _decryptChar(cipher, R)

### Function: _encryptChar(plain, R)

### Function: decrypt(cipherstring, R)

**Description:** Decrypts a string using the Type 1 encryption algorithm.
...
### Function: encrypt(plainstring, R)

**Description:** Encrypts a string using the Type 1 encryption algorithm.
