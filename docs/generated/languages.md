...
A file named languages.py.


### Function: get_official_languages(territory, regional, de_facto)

**Description:** Get the official language(s) for the given territory.
...
### Function: get_territory_language_info(territory)

**Description:** Get a dictionary of language information for a territory.
