...
A file named _axes.py.


### Function: _make_axes_method(func)

**Description:** Patch the qualname for functions that are directly added to Axes.
...
### Function: get_title(self, loc)

**Description:** Get an Axes title.
...
### Function: set_title(self, label, fontdict, loc, pad)
...
### Function: get_legend_handles_labels(self, legend_handler_map)
...
### Function: _remove_legend(self, legend)

### Function: inset_axes(self, bounds)

**Description:** Add a child inset Axes to this existing Axes.
...
### Function: indicate_inset(self, bounds, inset_ax)

**Description:** Add an inset indicator to the Axes.  This is a rectangle on the plot
...
### Function: indicate_inset_zoom(self, inset_ax)

**Description:** Add an inset indicator rectangle to the Axes based on the axis
...
### Function: secondary_xaxis(self, location, functions)

**Description:** Add a second x-axis to this `~.axes.Axes`.
...
### Function: secondary_yaxis(self, location, functions)

**Description:** Add a second y-axis to this `~.axes.Axes`.
...
**Description:** Add text to the Axes.
...
### Function: annotate(self, text, xy, xytext, xycoords, textcoords, arrowprops, annotation_clip)

### Function: axhline(self, y, xmin, xmax)

**Description:** Add a horizontal line spanning the whole or fraction of the Axes.
...
### Function: axvline(self, x, ymin, ymax)

**Description:** Add a vertical line spanning the whole or fraction of the Axes.
...
### Function: _check_no_units(vals, names)

### Function: axline(self, xy1, xy2)

**Description:** Add an infinitely long straight line.
...
### Function: axhspan(self, ymin, ymax, xmin, xmax)

**Description:** Add a horizontal span (rectangle) across the Axes.
...
### Function: axvspan(self, xmin, xmax, ymin, ymax)

**Description:** Add a vertical span (rectangle) across the Axes.
...
### Function: hlines(self, y, xmin, xmax, colors, linestyles, label)

**Description:** Plot horizontal lines at each *y* from *xmin* to *xmax*.
...
### Function: vlines(self, x, ymin, ymax, colors, linestyles, label)

**Description:** Plot vertical lines at each *x* from *ymin* to *ymax*.
...
### Function: eventplot(self, positions, orientation, lineoffsets, linelengths, linewidths, colors, alpha, linestyles)

**Description:** Plot identical parallel lines at the given positions.
...
### Function: plot_date(self, x, y, fmt, tz, xdate, ydate)

**Description:** Plot coercing the axis to treat floats as dates.
...
### Function: loglog(self)

**Description:** Make a plot with log scaling on both the x- and y-axis.
...
### Function: semilogx(self)

**Description:** Make a plot with log scaling on the x-axis.
...
### Function: semilogy(self)

**Description:** Make a plot with log scaling on the y-axis.
...
### Function: acorr(self, x)

**Description:** Plot the autocorrelation of *x*.
...
### Function: xcorr(self, x, y, normed, detrend, usevlines, maxlags)

**Description:** Plot the cross correlation between *x* and *y*.
...
### Function: step(self, x, y)

**Description:** Make a step plot.
...
**Description:** Small helper to do logic of width conversion flexibly.
...
### Function: _parse_bar_color_args(self, kwargs)

**Description:** Helper function to process color-related arguments of `.Axes.bar`.
...
### Function: bar(self, x, height, width, bottom)
...
### Function: barh(self, y, width, height, left)
...
### Function: bar_label(self, container, labels)

**Description:** Label a bar plot.
...
### Function: broken_barh(self, xranges, yrange)

**Description:** Plot a horizontal sequence of rectangles.
...
**Description:** Create a stem plot.
...
### Function: pie(self, x, explode, labels, colors, autopct, pctdistance, shadow, labeldistance, startangle, radius, counterclock, wedgeprops, textprops, center, frame, rotatelabels)
...
### Function: _errorevery_to_mask(x, errorevery)

**Description:** Normalize `errorbar`'s *errorevery* to be a boolean mask for data *x*.

This function is split out to be usable both by 2D and 3D errorbars.

### Function: errorbar(self, x, y, yerr, xerr, fmt, ecolor, elinewidth, capsize, barsabove, lolims, uplims, xlolims, xuplims, errorevery, capthick)

**Description:** Plot y versus x as lines and/or markers with attached errorbars.
...
### Function: boxplot(self, x, notch, sym, vert, orientation, whis, positions, widths, patch_artist, bootstrap, usermedians, conf_intervals, meanline, showmeans, showcaps, showbox, showfliers, boxprops, tick_labels, flierprops, medianprops, meanprops, capprops, whiskerprops, manage_ticks, autorange, zorder, capwidths, label)
...
### Function: bxp(self, bxpstats, positions, widths, vert, orientation, patch_artist, shownotches, showmeans, showcaps, showbox, showfliers, boxprops, whiskerprops, flierprops, medianprops, capprops, meanprops, meanline, manage_ticks, zorder, capwidths, label)

**Description:** Draw a box and whisker plot from pre-computed statistics.
...
### Function: _parse_scatter_color_args(c, edgecolors, kwargs, xsize, get_next_color_func)

**Description:** Helper function to process color related arguments of `.Axes.scatter`.
...
### Function: scatter(self, x, y, s, c, marker, cmap, norm, vmin, vmax, alpha, linewidths)
...
### Function: hexbin(self, x, y, C, gridsize, bins, xscale, yscale, extent, cmap, norm, vmin, vmax, alpha, linewidths, edgecolors, reduce_C_function, mincnt, marginals, colorizer)

**Description:** Make a 2D hexagonal binning plot of points *x*, *y*.
...
### Function: arrow(self, x, y, dx, dy)

**Description:** [*Discouraged*] Add an arrow to the Axes.
...
### Function: quiverkey(self, Q, X, Y, U, label)

### Function: _quiver_units(self, args, kwargs)

### Function: quiver(self)

**Description:** %(quiver_doc)s

### Function: barbs(self)

**Description:** %(barbs_doc)s

### Function: fill(self)

**Description:** Plot filled polygons.
...
### Function: _fill_between_x_or_y(self, ind_dir, ind, dep1, dep2)

**Description:** Fill the area between two {dir} curves.
...
### Function: _fill_between_process_units(self, ind_dir, dep_dir, ind, dep1, dep2)

**Description:** Handle united data, such as dates.

### Function: fill_between(self, x, y1, y2, where, interpolate, step)

### Function: fill_betweenx(self, y, x1, x2, where, step, interpolate)

### Function: imshow(self, X, cmap, norm)
...
### Function: _pcolorargs(self, funcname)

### Function: pcolor(self)

**Description:** Create a pseudocolor plot with a non-regular rectangular grid.
...
### Function: contour(self)

**Description:** Plot contour lines.
...
### Function: contourf(self)

**Description:** Plot filled contours.
...
### Function: clabel(self, CS, levels)
...
### Function: hist(self, x, bins, range, density, weights, cumulative, bottom, histtype, align, orientation, rwidth, log, color, label, stacked)
...
### Function: stairs(self, values, edges)

**Description:** Draw a stepwise constant function as a line or a filled plot.
...
### Function: hist2d(self, x, y, bins, range, density, weights, cmin, cmax)

**Description:** Make a 2D histogram plot.
...
### Function: ecdf(self, x, weights)

**Description:** Compute and plot the empirical cumulative distribution function of *x*.
...
### Function: psd(self, x, NFFT, Fs, Fc, detrend, window, noverlap, pad_to, sides, scale_by_freq, return_line)

**Description:** Plot the power spectral density.
...
### Function: csd(self, x, y, NFFT, Fs, Fc, detrend, window, noverlap, pad_to, sides, scale_by_freq, return_line)

**Description:** Plot the cross-spectral density.
...
### Function: magnitude_spectrum(self, x, Fs, Fc, window, pad_to, sides, scale)

**Description:** Plot the magnitude spectrum.
...
### Function: angle_spectrum(self, x, Fs, Fc, window, pad_to, sides)

**Description:** Plot the angle spectrum.
...
### Function: phase_spectrum(self, x, Fs, Fc, window, pad_to, sides)

**Description:** Plot the phase spectrum.
...
### Function: cohere(self, x, y, NFFT, Fs, Fc, detrend, window, noverlap, pad_to, sides, scale_by_freq)

**Description:** Plot the coherence between *x* and *y*.
...
### Function: specgram(self, x, NFFT, Fs, Fc, detrend, window, noverlap, cmap, xextent, pad_to, sides, scale_by_freq, mode, scale, vmin, vmax)

**Description:** Plot a spectrogram.
...
### Function: spy(self, Z, precision, marker, markersize, aspect, origin)

**Description:** Plot the sparsity pattern of a 2D array.
...
### Function: matshow(self, Z)

**Description:** Plot the values of a 2D matrix or array as color-coded image.
...
### Function: violinplot(self, dataset, positions, vert, orientation, widths, showmeans, showextrema, showmedians, quantiles, points, bw_method, side)

**Description:** Make a violin plot.
...
### Function: violin(self, vpstats, positions, vert, orientation, widths, showmeans, showextrema, showmedians, side)

**Description:** Draw a violin plot from pre-computed statistics.
...
### Function: _get_aspect_ratio(self)

**Description:** Convenience method to calculate the aspect ratio of the Axes in
the display coordinate system.

### Function: sign(x)

### Function: _upcast_err(err)

**Description:** Safely handle tuple of containers that carry units.
...
### Function: apply_mask(arrays, mask)

### Function: merge_kw_rc(subkey, explicit, zdelta, usemarker)

### Function: do_plot(xs, ys)

### Function: do_patch(xs, ys)

### Function: invalid_shape_exception(csize, xsize)

### Function: on_changed(collection)

### Function: _kde_method(X, coords)

### Function: get_next_color()

### Function: _interp_grid(X, require_monotonicity)
