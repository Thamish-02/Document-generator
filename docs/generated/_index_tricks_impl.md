...
A file named _index_tricks_impl.py.
...
**Description:** Construct a multi-dimensional "meshgrid".
...
**Description:** Translates slice objects to concatenation along an axis.
...
### Function: _fill_diagonal_dispatcher(a, val, wrap)

### Function: fill_diagonal(a, val, wrap)
...
### Function: _diag_indices_from(arr)

### Function: diag_indices_from(arr)
...
### Function: __init__(self, axis, matrix, ndmin, trans1d)
...
**Description:** Standard iterator method, returns the index tuple and array value.
...
**Description:** Standard iterator method, updates the index and returns the index
tuple.
...
### Function: __init__(self, maketuple)
