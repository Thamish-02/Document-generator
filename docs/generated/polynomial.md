...
A file named polynomial.py.


### Function: polyline(off, scl)
...
### Function: polypow(c, pow, maxpower)
...
### Function: polyint(c, m, k, lbnd, scl, axis)
...
### Function: polyvalfromroots(x, r, tensor)
...
### Function: polyvander3d(x, y, z, deg)
...
### Function: polyfit(x, y, deg, rcond, full, w)
...
### Function: _str_term_ascii(i, arg_str)

### Function: _repr_latex_term(i, arg_str, needs_parens)
