...
A file named macCreatorType.py.


### Function: _reverseString(s)

### Function: getMacCreatorAndType(path)

**Description:** Returns file creator and file type codes for a path.
...
### Function: setMacCreatorAndType(path, fileCreator, fileType)

**Description:** Set file creator and file type codes for a path.
