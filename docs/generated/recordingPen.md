...
A file named recordingPen.py.


### Function: replayRecording(recording, pen)

**Description:** Replay a recording, as produced by RecordingPen or DecomposingRecordingPen,
to a pen.
...
**Description:** Pen recording operations that can be accessed or replayed.
...
## Class: DecomposingRecordingPen

**Description:** Same as RecordingPen, except that it doesn't keep components
...
## Class: RecordingPointPen

**Description:** PointPen recording operations that can be accessed or replayed.
...
## Class: DecomposingRecordingPointPen

**Description:** Same as RecordingPointPen, except that it doesn't keep components
as references, but draws them decomposed as regular contours.
...
### Function: lerpRecordings(recording1, recording2, factor)

**Description:** Linearly interpolate between two recordings. The recordings
...
### Function: moveTo(self, p0)

### Function: lineTo(self, p1)
...
### Function: addVarComponent(self, baseGlyphName, transformation, location, identifier)

### Function: replay(self, pointPen)
