...
A file named fixedTools.py.


### Function: fixedToFloat(value, precisionBits)

**Description:** Converts a fixed-point number to a float given the number of
precision bits.
...
### Function: floatToFixed(value, precisionBits)

**Description:** Converts a float to a fixed-point number given the number of
precision bits.
...
### Function: floatToFixedToFloat(value, precisionBits)

**Description:** Converts a float to a fixed-point number and back again.
...
### Function: fixedToStr(value, precisionBits)

**Description:** Converts a fixed-point number to a string representing a decimal float.
...
### Function: strToFixed(string, precisionBits)

**Description:** Converts a string representing a decimal float to a fixed-point number.
...
### Function: strToFixedToFloat(string, precisionBits)

**Description:** Convert a string to a decimal float with fixed-point rounding.
...
### Function: floatToFixedToStr(value, precisionBits)

**Description:** Convert float to string with fixed-point rounding.
...
### Function: ensureVersionIsLong(value)

**Description:** Ensure a table version is an unsigned long.
...
### Function: versionToFixed(value)

**Description:** Ensure a table version number is fixed-point.
