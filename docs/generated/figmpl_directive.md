...
A file named figmpl_directive.py.
...
**Description:** Implements a directive to allow an optional hidpi image.
...
### Function: _parse_srcsetNodes(st)

**Description:** parse srcset...

### Function: _copy_images_figmpl(self, node)

### Function: visit_figmpl_html(self, node)

### Function: visit_figmpl_latex(self, node)

### Function: depart_figmpl_html(self, node)

### Function: depart_figmpl_latex(self, node)

### Function: figurempl_addnode(app)
