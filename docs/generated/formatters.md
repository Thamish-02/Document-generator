...
**Description:** Try to return a repr of an object

always returns a string, at least.

## Class: FormatterWarning

**Description:** Warning class for errors in formatters

### Function: catch_format_error(method, self)

**Description:** show traceback on failed format call

## Class: FormatterABC

**Description:** Abstract base class for Formatters.
...
### Function: _mod_name_key(typ)

**Description:** Return a (__module__, __name__) tuple for a type.

Used as key in Formatter.deferred_printers.

### Function: _get_type(obj)

**Description:** Return the type of an instance (old and new-style)

## Class: BaseFormatter

**Description:** A base formatter class that is configurable.
...
**Description:** The default pretty-printer.
...
**Description:** A JSON string formatter.
...
## Class: IPythonDisplayFormatter

**Description:** An escape-hatch Formatter for objects that know how to display themselves.
...
## Class: MimeBundleFormatter

**Description:** A Formatter for arbitrary mime-types.
...
### Function: format_display_data(obj, include, exclude)

**Description:** Return a format data dict for an object.
...
### Function: _active_types_default(self)

### Function: _active_types_changed(self, change)

### Function: _default_formatter(self)

### Function: _default_mime_formatter(self)

### Function: _formatters_default(self)

**Description:** Activate the default formatters.

### Function: format(self, obj, include, exclude)
...
### Function: format_types(self)

**Description:** Return the format types (MIME types) of the active formatters.

### Function: __call__(self, obj)

**Description:** Return a JSON'able representation of the object.
...
**Description:** Compute the format for an object.

### Function: __contains__(self, typ)

**Description:** map in to lookup_by_type

### Function: _check_return(self, r, obj)

**Description:** Check that a return value is appropriate

Return the value if so, None otherwise, warning if invalid.

### Function: lookup(self, obj)

**Description:** Look up the formatter for a given instance.
...
### Function: lookup_by_type(self, typ)

**Description:** Look up the registered formatter for a type.
...
### Function: for_type(self, typ, func)

**Description:** Add a format function for a given type.
...
### Function: for_type_by_name(self, type_module, type_name, func)

**Description:** Add a format function for a type specified by the full dotted
...
### Function: pop(self, typ, default)

**Description:** Pop a formatter for the given type.
...
### Function: _float_precision_changed(self, change)

**Description:** float_precision changed, set float_format accordingly.
...
### Function: _singleton_printers_default(self)

### Function: _type_printers_default(self)

### Function: _deferred_printers_default(self)

### Function: __call__(self, obj)

**Description:** Compute the pretty representation of the object.
...
### Function: __call__(self, obj, include, exclude)
