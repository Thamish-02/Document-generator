...
A file named widget_upload.py.


### Function: _deserialize_single_file(js)

### Function: _deserialize_value(js, _)

### Function: _serialize_single_file(uploaded_file)

### Function: _serialize_value(value, _)
...
### Function: _default_description(self)
