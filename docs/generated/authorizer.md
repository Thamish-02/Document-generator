...
A file named authorizer.py.


## Class: Authorizer

**Description:** Base class for authorizing access to resources
...
**Description:** A no-op implementation of the Authorizer

This authorizer allows all authenticated requests.

.. versionadded:: 2.0

### Function: is_authorized(self, handler, user, action, resource)

**Description:** A method to determine if ``user`` is authorized to perform ``action``
