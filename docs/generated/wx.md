...
### Function: ignore_keyboardinterrupts(func)

**Description:** Decorator which causes KeyboardInterrupt exceptions to be ignored during
...
### Function: inputhook_wx1(context)

**Description:** Run the wx event loop by processing pending events only.
...
### Function: inputhook_wx2(context)

**Description:** Run the wx event loop, polling for stdin.
...
### Function: inputhook_wx3(context)
...
### Function: inputhook_wxphoenix(context)

**Description:** Run the wx event loop until the user provides more input.
...
### Function: Run(self, time, input_is_ready)

### Function: check_stdin(self)
