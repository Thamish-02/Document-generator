...
A file named defmatrix.py.


### Function: _convert_from_string(data)

### Function: asmatrix(data, dtype)
...
### Function: _from_string(str, gdict, ldict)

### Function: bmat(obj, ldict, gdict)
...
### Function: __new__(subtype, data, dtype, copy)
...
### Function: _align(self, axis)

**Description:** A convenience function for operations that need to preserve axis
orientation.

### Function: _collapse(self, axis)

**Description:** A convenience function for operations that want to collapse
...
### Function: mean(self, axis, dtype, out)
...
### Function: std(self, axis, dtype, out, ddof)
...
### Function: var(self, axis, dtype, out, ddof)
...
### Function: prod(self, axis, dtype, out)
