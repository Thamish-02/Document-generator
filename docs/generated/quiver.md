...
A file named quiver.py.


## Class: QuiverKey

**Description:** Labelled arrow for use as a quiver plot scale key.

### Function: _parse_args()

**Description:** Helper function to parse positional parameters for colored vector plots.
...
**Description:** Specialized PolyCollection for arrows.
...
**Description:** Specialized PolyCollection for barbs.
...
### Function: __init__(self, Q, X, Y, U, label)

**Description:** Add a key to a quiver plot.
...
### Function: labelsep(self)

### Function: _init(self)

### Function: _text_shift(self)

### Function: draw(self, renderer)

### Function: _set_transform(self)
...
**Description:** The constructor takes one required argument, an Axes
...
**Description:** Initialization delayed until first draw;
...
### Function: set_UVC(self, U, V, C)

### Function: _dots_per_unit(self, units)

**Description:** Return a scale factor for converting from units to pixels.

### Function: _set_transform(self)

**Description:** Set the PolyCollection transform to go
from arrow width units to pixels.

### Function: _angles_lengths(self, XY, U, V, eps)

### Function: _make_verts(self, XY, U, V, angles)

### Function: _h_arrows(self, length)

**Description:** Length is in arrow width units.
...
### Function: _find_tails(self, mag, rounding, half, full, flag)

**Description:** Find how many of each of the tail pieces is necessary.
...
### Function: _make_barbs(self, u, v, nflags, nbarbs, half_barb, empty_flag, length, pivot, sizes, fill_empty, flip)

**Description:** Create the wind barbs.
...
### Function: set_offsets(self, xy)

**Description:** Set the offsets for the barb polygons.  This saves the offsets passed
