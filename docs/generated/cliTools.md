...
A file named cliTools.py.


### Function: makeOutputFileName(input, outputDir, extension, overWrite, suffix)

**Description:** Generates a suitable file name for writing output.
