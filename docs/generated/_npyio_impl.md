...
A file named _npyio_impl.py.


## Class: BagObj

**Description:** BagObj(obj)
...
### Function: load(file, mmap_mode, allow_pickle, fix_imports, encoding)
...
### Function: _save_dispatcher(file, arr, allow_pickle, fix_imports)

### Function: save(file, arr, allow_pickle, fix_imports)
...
### Function: _savez_dispatcher(file)
...
### Function: _savez_compressed_dispatcher(file)

### Function: savez_compressed(file)
...
### Function: _savez(file, args, kwds, compress, allow_pickle, pickle_kwargs)

### Function: _ensure_ndmin_ndarray_check_param(ndmin)

**Description:** Just checks if the param ndmin is supported on
_ensure_ndmin_ndarray. It is intended to be used as
verification before running anything expensive.
e.g. loadtxt, genfromtxt

### Function: _ensure_ndmin_ndarray(a)

**Description:** This is a helper function of loadtxt and genfromtxt to ensure
...
### Function: _check_nonneg_int(value, name)

### Function: _preprocess_comments(iterable, comments, encoding)

**Description:** Generator that consumes a line iterated iterable and strips out the
...
**Description:** Read a NumPy array from a text file.
...
### Function: loadtxt(fname, dtype, comments, delimiter, converters, skiprows, usecols, unpack, ndmin, encoding, max_rows)
...
### Function: _savetxt_dispatcher(fname, X, fmt, delimiter, newline, header, footer, comments, encoding)

### Function: savetxt(fname, X, fmt, delimiter, newline, header, footer, comments, encoding)
...
### Function: fromregex(file, regexp, dtype, encoding)
...
### Function: genfromtxt(fname, dtype, comments, delimiter, skip_header, skip_footer, converters, missing_values, filling_values, usecols, names, excludelist, deletechars, replace_space, autostrip, case_sensitive, defaultfmt, unpack, usemask, loose, invalid_raise, max_rows, encoding)
...
**Description:** Enables dir(bagobj) to list the files in an NpzFile.

This also enables tab-completion in an interpreter or IPython.

### Function: __init__(self, fid, own_fid, allow_pickle, pickle_kwargs)
...
**Description:** Convert to bytes on bytestream inputs.

        

### Function: __init__(self, fh, encoding)

### Function: close(self)

### Function: write(self, v)

### Function: write_bytes(self, v)

### Function: write_normal(self, v)

### Function: first_write(self, v)

### Function: encode_unicode_cols(row_tup)

### Function: tobytes_first(x, conv)
