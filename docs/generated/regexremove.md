...
A file named regexremove.py.


## Class: RegexRemovePreprocessor

**Description:** Removes cells from a notebook that match one or more regular expression.
...
### Function: check_conditions(self, cell)

**Description:** Checks that a cell matches the pattern.
