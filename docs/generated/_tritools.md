...
### Function: circle_ratios(self, rescale)
...
### Function: get_flat_tri_mask(self, min_circle_ratio, rescale)
...
### Function: _get_compressed_triangulation(self)

**Description:** Compress (if masked) the encapsulated triangulation.
...
### Function: _total_to_compress_renum(valid)
