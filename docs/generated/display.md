...
A file named display.py.


## Class: Audio

**Description:** Create an audio object.
...
**Description:** Generic class to embed an iframe in an IPython notebook

## Class: YouTubeVideo

**Description:** Class for embedding a YouTube Video in an IPython session, based on its video id.
...
**Description:** Class for embedding a Vimeo video in an IPython session, based on its video id.

## Class: ScribdDocument

**Description:** Class for embedding a Scribd document in an IPython session
...
**Description:** Class for embedding a local file link in an IPython session, based on path
...
**Description:** Class for embedding local file links in an IPython session, based on path
...
**Description:** Display syntax-highlighted source code.
...
### Function: __init__(self, data, filename, url, embed, rate, autoplay, normalize)

### Function: reload(self)

**Description:** Reload the raw data from file or URL.

### Function: _make_wav(data, rate, normalize)

**Description:** Transform a numpy array to a PCM bytestring 

### Function: _validate_and_normalize_with_numpy(data, normalize)

### Function: _validate_and_normalize_without_numpy(data, normalize)

### Function: _get_normalization_factor(max_abs_value, normalize)

### Function: _data_and_metadata(self)

**Description:** shortcut for returning metadata with url information, if defined

### Function: _repr_html_(self)

### Function: src_attr(self)

### Function: autoplay_attr(self)

### Function: element_id_attr(self)

### Function: __init__(self, src, width, height, extras)

### Function: _repr_html_(self)

**Description:** return the embed iframe

### Function: __init__(self, id, width, height, allow_autoplay)

### Function: _repr_jpeg_(self)

### Function: __init__(self, id, width, height)

### Function: __init__(self, id, width, height)

### Function: __init__(self, path, url_prefix, result_html_prefix, result_html_suffix)
...
### Function: _format_path(self)

### Function: _repr_html_(self)

**Description:** return html link to file
...
### Function: __init__(self, path, url_prefix, included_suffixes, result_html_prefix, result_html_suffix, notebook_display_formatter, terminal_display_formatter, recursive)

**Description:** See :class:`FileLink` for the ``path``, ``url_prefix``,
...
### Function: _get_display_formatter(self, dirname_output_format, fname_output_format, fp_format, fp_cleaner)

**Description:** generate built-in formatter function
...
### Function: _get_notebook_display_formatter(self, spacer)

**Description:** generate function to use for notebook formatting
        

### Function: _get_terminal_display_formatter(self, spacer)

**Description:** generate function to use for terminal formatting
...
**Description:** return newline-separated absolute paths
        

### Function: __init__(self, data, url, filename, language)

### Function: _get_lexer(self)
...
### Function: f(dirname, fnames, included_suffixes)

### Function: fp_cleaner(fp)
