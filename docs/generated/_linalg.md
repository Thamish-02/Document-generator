...
### Function: _raise_linalgerror_singular(err, flag)

### Function: _raise_linalgerror_nonposdef(err, flag)

### Function: _raise_linalgerror_eigenvalues_nonconvergence(err, flag)

### Function: _raise_linalgerror_svd_nonconvergence(err, flag)

### Function: _raise_linalgerror_lstsq(err, flag)

### Function: _raise_linalgerror_qr(err, flag)

### Function: _makearray(a)

### Function: isComplexType(t)

### Function: _realType(t, default)

### Function: _complexType(t, default)
...
### Function: _tensorsolve_dispatcher(a, b, axes)

### Function: tensorsolve(a, b, axes)
...
### Function: _solve_dispatcher(a, b)
...
### Function: _tensorinv_dispatcher(a, ind)

### Function: tensorinv(a, ind)
...
### Function: _matrix_power_dispatcher(a, n)
...
### Function: _outer_dispatcher(x1, x2)
...
### Function: _qr_dispatcher(a, mode)
...
### Function: _eigvalsh_dispatcher(a, UPLO)

### Function: eigvalsh(a, UPLO)
...
### Function: _svd_dispatcher(a, full_matrices, compute_uv, hermitian)

### Function: svd(a, full_matrices, compute_uv, hermitian)
...
### Function: _svdvals_dispatcher(x)
...
### Function: _matrix_rank_dispatcher(A, tol, hermitian)

### Function: matrix_rank(A, tol, hermitian)
...
### Function: _pinv_dispatcher(a, rcond, hermitian)

### Function: pinv(a, rcond, hermitian)
...
### Function: _lstsq_dispatcher(a, b, rcond)
...
### Function: _multi_svd_norm(x, row_axis, col_axis, op)

**Description:** Compute a function of the singular values of the 2-D matrices in `x`.
...
### Function: _norm_dispatcher(x, ord, axis, keepdims)

### Function: norm(x, ord, axis, keepdims)
...
### Function: _multidot_dispatcher(arrays)

### Function: multi_dot(arrays)
...
### Function: _multi_dot_three(A, B, C, out)

**Description:** Find the best order for three arrays and do the multiplication.

For three arguments `_multi_dot_three` is approximately 15 times faster
than `_multi_dot_matrix_chain_order`

### Function: _multi_dot_matrix_chain_order(arrays, return_costs)

**Description:** Return a np.array that encodes the optimal order of multiplications.
...
### Function: _multi_dot(arrays, order, i, j, out)

**Description:** Actually do the multiplication with the given order.
...
### Function: _matrix_norm_dispatcher()
...
### Function: _vector_norm_dispatcher()
