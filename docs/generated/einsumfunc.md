...
A file named einsumfunc.py.


### Function: _flop_count(idx_contraction, inner, num_terms, size_dictionary)

**Description:** Computes the number of FLOPS in the contraction.
...
### Function: _compute_size_by_dict(indices, idx_dict)

**Description:** Computes the product of the elements in indices based on the dictionary
idx_dict.
...
### Function: _find_contraction(positions, input_sets, output_set)

**Description:** Finds the contraction for a given set of input and output sets.
...
### Function: _optimal_path(input_sets, output_set, idx_dict, memory_limit)

**Description:** Computes all possible pair contractions, sieves the results based
...
### Function: _parse_possible_contraction(positions, input_sets, output_set, idx_dict, memory_limit, path_cost, naive_cost)

**Description:** Compute the cost (removed size + flops) and resultant indices for
...
### Function: _update_other_results(results, best)

**Description:** Update the positions and provisional input_sets of ``results``
...
### Function: _greedy_path(input_sets, output_set, idx_dict, memory_limit)

**Description:** Finds the path by contracting the best pair until the input list is
...
### Function: _can_dot(inputs, result, idx_removed)

**Description:** Checks if we can use BLAS (np.tensordot) call and its beneficial to do so.
...
### Function: _parse_einsum_input(operands)

**Description:** A reproduction of einsum c side einsum parsing in python.
