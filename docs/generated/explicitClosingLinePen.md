...
A file named explicitClosingLinePen.py.


## Class: ExplicitClosingLinePen

**Description:** A filter pen that adds an explicit lineTo to the first point of each closed
