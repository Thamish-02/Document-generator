...
A file named frame.py.


### Function: extract_vars()

**Description:** Extract a set of variables by name from another frame.
...
### Function: debugx(expr, pre_msg)

**Description:** Print the value of an expression from the caller's frame.
...
### Function: extract_module_locals(depth)

**Description:** Returns (module, locals) of the function `depth` frames away from the caller
