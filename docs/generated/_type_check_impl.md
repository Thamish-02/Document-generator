...
A file named _type_check_impl.py.


### Function: mintypecode(typechars, typeset, default)
...
### Function: _is_type_dispatcher(x)
...
### Function: _getmaxmin(t)

### Function: _nan_to_num_dispatcher(x, copy, nan, posinf, neginf)

### Function: nan_to_num(x, copy, nan, posinf, neginf)
...
### Function: _real_if_close_dispatcher(a, tol)

### Function: real_if_close(a, tol)
