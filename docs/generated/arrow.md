...
A file named arrow.py.


## Class: Arrow

**Description:** An :class:`Arrow <arrow.arrow.Arrow>` object.
...
### Function: __init__(self, year, month, day, hour, minute, second, microsecond, tzinfo)

### Function: now(cls, tzinfo)

**Description:** Constructs an :class:`Arrow <arrow.arrow.Arrow>` object, representing "now" in the given
timezone.
...
**Description:** Constructs an :class:`Arrow <arrow.arrow.Arrow>` object, representing "now" in UTC
time.
...
### Function: fromtimestamp(cls, timestamp, tzinfo)

**Description:** Constructs an :class:`Arrow <arrow.arrow.Arrow>` object from a timestamp, converted to
the given timezone.

:param timestamp: an ``int`` or ``float`` timestamp, or a ``str`` that converts to either.
:param tzinfo: (optional) a ``tzinfo`` object.  Defaults to local time.

### Function: utcfromtimestamp(cls, timestamp)

**Description:** Constructs an :class:`Arrow <arrow.arrow.Arrow>` object from a timestamp, in UTC time.

:param timestamp: an ``int`` or ``float`` timestamp, or a ``str`` that converts to either.

### Function: fromdatetime(cls, dt, tzinfo)

**Description:** Constructs an :class:`Arrow <arrow.arrow.Arrow>` object from a ``datetime`` and
...
### Function: fromdate(cls, date, tzinfo)

**Description:** Constructs an :class:`Arrow <arrow.arrow.Arrow>` object from a ``date`` and optional
replacement timezone.  All time values are set to 0.

:param date: the ``date``
:param tzinfo: (optional) A :ref:`timezone expression <tz-expr>`.  Defaults to UTC.

### Function: strptime(cls, date_str, fmt, tzinfo)

**Description:** Constructs an :class:`Arrow <arrow.arrow.Arrow>` object from a date string and format,
...
### Function: fromordinal(cls, ordinal)

**Description:** Constructs an :class:`Arrow <arrow.arrow.Arrow>` object corresponding
...
### Function: range(cls, frame, start, end, tz, limit)

**Description:** Returns an iterator of :class:`Arrow <arrow.arrow.Arrow>` objects, representing
...
### Function: span(self, frame, count, bounds, exact, week_start)

**Description:** Returns a tuple of two new :class:`Arrow <arrow.arrow.Arrow>` objects, representing the timespan
...
### Function: floor(self, frame)

**Description:** Returns a new :class:`Arrow <arrow.arrow.Arrow>` object, representing the "floor"
...
### Function: ceil(self, frame)

**Description:** Returns a new :class:`Arrow <arrow.arrow.Arrow>` object, representing the "ceiling"
of the timespan of the :class:`Arrow <arrow.arrow.Arrow>` object in a given timeframe.
...
### Function: span_range(cls, frame, start, end, tz, limit, bounds, exact)

**Description:** Returns an iterator of tuples, each :class:`Arrow <arrow.arrow.Arrow>` objects,
...
### Function: interval(cls, frame, start, end, interval, tz, bounds, exact)
...
### Function: __format__(self, formatstr)

### Function: __hash__(self)

### Function: __getattr__(self, name)

### Function: tzinfo(self)

**Description:** Gets the ``tzinfo`` of the :class:`Arrow <arrow.arrow.Arrow>` object.
...
**Description:** Returns a datetime representation of the :class:`Arrow <arrow.arrow.Arrow>` object.
...
**Description:** Returns a naive datetime representation of the :class:`Arrow <arrow.arrow.Arrow>`
object.
...
**Description:** Returns a timestamp representation of the :class:`Arrow <arrow.arrow.Arrow>` object, in
UTC time.
...
### Function: int_timestamp(self)

**Description:** Returns an integer timestamp representation of the :class:`Arrow <arrow.arrow.Arrow>` object, in
UTC time.
...
### Function: float_timestamp(self)

**Description:** Returns a floating-point timestamp representation of the :class:`Arrow <arrow.arrow.Arrow>`
object, in UTC time.
...
**Description:** Returns the ``fold`` value of the :class:`Arrow <arrow.arrow.Arrow>` object.

### Function: ambiguous(self)

**Description:** Indicates whether the :class:`Arrow <arrow.arrow.Arrow>` object is a repeated wall time in the current
timezone.

### Function: imaginary(self)

**Description:** Indicates whether the :class: `Arrow <arrow.arrow.Arrow>` object exists in the current timezone.

### Function: clone(self)

**Description:** Returns a new :class:`Arrow <arrow.arrow.Arrow>` object, cloned from the current one.
...
**Description:** Returns a new :class:`Arrow <arrow.arrow.Arrow>` object with attributes updated
according to inputs.
...
### Function: shift(self, check_imaginary)
...
**Description:** Returns a new :class:`Arrow <arrow.arrow.Arrow>` object, converted
...
### Function: format(self, fmt, locale)

**Description:** Returns a string representation of the :class:`Arrow <arrow.arrow.Arrow>` object,
...
### Function: humanize(self, other, locale, only_distance, granularity)

**Description:** Returns a localized, humanized representation of a relative difference in time.
...
### Function: dehumanize(self, input_string, locale)

**Description:** Returns a new :class:`Arrow <arrow.arrow.Arrow>` object, that represents
...
### Function: is_between(self, start, end, bounds)

**Description:** Returns a boolean denoting whether the :class:`Arrow <arrow.arrow.Arrow>` object is between
...
**Description:** Returns a ``date`` object with the same year, month and day.
...
**Description:** Returns a ``time`` object with the same hour, minute, second, microsecond.
...
### Function: timetz(self)

**Description:** Returns a ``time`` object with the same hour, minute, second, microsecond and
tzinfo.
...
### Function: astimezone(self, tz)

**Description:** Returns a ``datetime`` object, converted to the specified timezone.
...
### Function: utcoffset(self)

**Description:** Returns a ``timedelta`` object representing the whole number of minutes difference from
UTC time.
...
**Description:** Returns the daylight savings time adjustment.
...
### Function: timetuple(self)

**Description:** Returns a ``time.struct_time``, in the current timezone.
...
### Function: utctimetuple(self)

**Description:** Returns a ``time.struct_time``, in UTC time.
...
### Function: toordinal(self)

**Description:** Returns the proleptic Gregorian ordinal of the date.
...
**Description:** Returns the day of the week as an integer (0-6).
...
### Function: isoweekday(self)

**Description:** Returns the ISO day of the week as an integer (1-7).
...
**Description:** Returns a 3-tuple, (ISO year, ISO week number, ISO weekday).
...
### Function: isoformat(self, sep, timespec)

**Description:** Returns an ISO 8601 formatted representation of the date and time.
...
**Description:** Returns a ctime formatted representation of the date and time.
...
**Description:** Formats in the style of ``datetime.strftime``.
...
### Function: for_json(self)

**Description:** Serializes for the ``for_json`` protocol of simplejson.
...
### Function: _get_tzinfo(tz_expr)

**Description:** Get normalized tzinfo object from various inputs.

### Function: _get_datetime(cls, expr)

**Description:** Get datetime object from a specified expression.

### Function: _get_frames(cls, name)

**Description:** Finds relevant timeframe and steps for use in range and span methods.

Returns a 3 element tuple in the form (frame, plural frame, step), for example ("day", "days", 1)

### Function: _get_iteration_params(cls, end, limit)

**Description:** Sets default end and limit values for range method.

### Function: _is_last_day_of_month(date)

**Description:** Returns a boolean indicating whether the datetime is the last day of the month.

### Function: gather_timeframes(_delta, _frame)
