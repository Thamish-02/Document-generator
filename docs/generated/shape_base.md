...
### Function: _arrays_for_stack_dispatcher(arrays)

### Function: _vhstack_dispatcher(tup)
...
### Function: _stack_dispatcher(arrays, axis, out)

### Function: stack(arrays, axis, out)
...
### Function: _block_format_index(index)

**Description:** Convert a list of indices ``[0, 1, 2]`` into ``"arrays[0][1][2]"``.

### Function: _block_check_depths_match(arrays, parent_index)

**Description:** Recursive function checking that the depths of nested lists in `arrays`
...
### Function: _atleast_nd(a, ndim)

### Function: _accumulate(values)

### Function: _concatenate_shapes(shapes, axis)

**Description:** Given array shapes, return the resulting shape and slices prefixes.
...
### Function: _block_info_recursion(arrays, max_depth, result_ndim, depth)

**Description:** Returns the shape of the final array, along with a list
...
### Function: _block(arrays, max_depth, result_ndim, depth)

**Description:** Internal implementation of block based on repeated concatenation.
...
### Function: _block_dispatcher(arrays)
...
### Function: _block_setup(arrays)

**Description:** Returns
(`arrays`, list_ndim, result_ndim, final_size)

### Function: _block_slicing(arrays, list_ndim, result_ndim)

### Function: _block_concatenate(arrays, list_ndim, result_ndim)
