...
A file named hermite_e.py.


### Function: poly2herme(pol)
...
### Function: hermepow(c, pow, maxpower)
...
### Function: hermeder(c, m, scl, axis)
...
### Function: hermeint(c, m, k, lbnd, scl, axis)
...
### Function: hermevander2d(x, y, deg)
...
### Function: hermevander3d(x, y, z, deg)
...
### Function: hermefit(x, y, deg, rcond, full, w)
...
### Function: _normed_hermite_e_n(x, n)

**Description:** Evaluate a normalized HermiteE polynomial.
