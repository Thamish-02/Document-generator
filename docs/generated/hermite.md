...
A file named hermite.py.


### Function: poly2herm(pol)
...
### Function: hermpow(c, pow, maxpower)
...
### Function: hermint(c, m, k, lbnd, scl, axis)
...
### Function: hermvander3d(x, y, z, deg)
...
### Function: hermfit(x, y, deg, rcond, full, w)
...
### Function: _normed_hermite_n(x, n)
