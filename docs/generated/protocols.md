...
A file named protocols.py.


## Class: Validator

**Description:** The protocol to which all validator classes adhere.
...
### Function: __init__(self, schema, resolver, format_checker)

### Function: check_schema(cls, schema)

**Description:** Validate the given schema against the validator's `META_SCHEMA`.
...
### Function: is_type(self, instance, type)

**Description:** Check if the instance is of the given (JSON Schema) type.
...
### Function: is_valid(self, instance)

**Description:** Check if the instance is valid under the current `schema`.
...
**Description:** Lazily yield each of the validation errors in the given instance.
...
### Function: validate(self, instance)
...
**Description:** Create a new validator like this one, but with given changes.
