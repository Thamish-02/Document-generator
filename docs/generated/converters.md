...
A file named converters.py.


### Function: convertUFO1OrUFO2KerningToUFO3Kerning(kerning, groups, glyphSet)

**Description:** Convert kerning data in UFO1 or UFO2 syntax into UFO3 syntax.
...
**Description:** Find all kerning groups in a UFO1 or UFO2 font that use known prefixes.
...
### Function: makeUniqueGroupName(name, groupNames, counter)

**Description:** Make a kerning group name that will be unique within the set of group names.
...
**Description:** Tests for :func:`.convertUFO1OrUFO2KerningToUFO3Kerning`.
