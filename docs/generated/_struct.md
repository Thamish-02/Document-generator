...
A file named _struct.py.


## Class: Struct

**Description:** A dict subclass with attribute style access.
...
**Description:** Initialize with a dictionary, another Struct, or data.
...
**Description:** Set an item with check for allownew.
...
**Description:** Set an attr with protection of class members.
...
**Description:** Get an attr by calling :meth:`dict.__getitem__`.
...
**Description:** s += s2 is a shorthand for s.merge(s2).
...
**Description:** s + s2 -> New Struct made from s.merge(s2).
...
**Description:** s1 - s2 -> remove keys in s2 from s1.
...
**Description:** Inplace remove keys from self that are in other.
...
### Function: __dict_invert(self, data)

**Description:** Helper function for merge.
...
**Description:** Get the dict representation of the struct.

### Function: copy(self)

**Description:** Return a copy as a Struct.
...
### Function: hasattr(self, key)

**Description:** hasattr function available as a method.
...
### Function: allow_new_attr(self, allow)

**Description:** Set whether new attributes can be created in this Struct.

This can be used to catch typos by verifying that the attribute user
tries to change already exists in this Struct.

### Function: merge(self, __loc_data__, __conflict_solve)

**Description:** Merge two Structs with customizable conflict resolution.
