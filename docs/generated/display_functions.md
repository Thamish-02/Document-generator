...
A file named display_functions.py.


### Function: _merge(d1, d2)

**Description:** Like update, but merges sub-dicts instead of clobbering at the top level.

Updates d1 in-place

## Class: _Sentinel

### Function: publish_display_data(data, metadata, source)
...
**Description:** Generate a new random text id with urandom
...
**Description:** A handle on an updatable display
...
### Function: clear_output(wait)

**Description:** Clear the output of the current cell receiving output.
...
### Function: __init__(self, display_id)

### Function: __repr__(self)

### Function: display(self, obj)

**Description:** Make a new display with my id, updating existing instances.
...
**Description:** Update existing displays with my id
