...
A file named roundTools.py.


### Function: noRound(value)

### Function: otRound(value)

**Description:** Round float value to nearest integer towards ``+Infinity``.
...
### Function: maybeRound(v, tolerance, round)

### Function: roundFunc(tolerance, round)

### Function: nearestMultipleShortestRepr(value, factor)

**Description:** Round to nearest multiple of factor and return shortest decimal representation.
