...
A file named _blocking_input.py.


### Function: blocking_input_loop(figure, event_names, timeout, handler)

**Description:** Run *figure*'s event loop while listening to interactive events.
