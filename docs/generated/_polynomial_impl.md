...
A file named _polynomial_impl.py.


### Function: _poly_dispatcher(seq_of_zeros)

### Function: poly(seq_of_zeros)
...
### Function: _polyint_dispatcher(p, m, k)

### Function: polyint(p, m, k)
...
### Function: _polyder_dispatcher(p, m)

### Function: polyder(p, m)
...
### Function: _polyfit_dispatcher(x, y, deg, rcond, full, w, cov)
...
### Function: _polyval_dispatcher(p, x)
...
### Function: _binary_op_dispatcher(a1, a2)
...
### Function: _polydiv_dispatcher(u, v)
...
### Function: _raise_power(astr, wrap)
...
### Function: coeffs(self)

**Description:** The polynomial coefficients 

### Function: coeffs(self, value)

### Function: variable(self)

**Description:** The name of the polynomial variable 

### Function: order(self)

**Description:** The order or degree of the polynomial 

### Function: roots(self)

**Description:** The roots of the polynomial, where self(x) == 0 

### Function: _coeffs(self)

### Function: _coeffs(self, coeffs)

### Function: __init__(self, c_or_r, r, variable)

### Function: __array__(self, t, copy)
...
### Function: __getitem__(self, val)

### Function: __setitem__(self, key, val)

### Function: __iter__(self)

### Function: integ(self, m, k)
